...
public class HangmanGame {
    ...
    public HangmanGame(final List<HangmanChar> characters) {
        ...
        this.hangmanPaths = buildHangmanPathPositions();
        buildHangamanDesign(whiteSpaces, characterSpace);
    ...
    private List<HangmanChar> buildHangmanPathPositions() {
    ...
    private void buildHangamanDesign(final String whiteSpaces, final String characterSpaces){
